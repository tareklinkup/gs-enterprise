        ...
        public function addProductTransfer(){
            ...
            try{
                ...
                foreach($data->cart as $cartProduct){
                    ...
                    // $transferToBranchInventoryCount = $this->db->query("select * from tbl_currentinventory where product_id = ? and size_id = ? and color_id = ? and branch_id = ?", [$cartProduct->product_id, $cartProduct->size_id, $cartProduct->color_id, $data->transfer->transfer_to])->num_rows();
                    ...
                    //         and color_id = ?
                    //         and branch_id = ?
                    //     ", [$cartProduct->quantity, $cartProduct->product_id, $cartProduct->size_id, $cartProduct->color_id, $data->transfer->transfer_to]);
                    // }
                }
