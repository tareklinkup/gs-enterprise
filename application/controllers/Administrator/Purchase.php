...
class Purchase extends CI_Controller
{
    ...
    public function getPurchases(){
        ...
        if(isset($data->purchaseId) && $data->purchaseId != null){
            ...
            if($size_color->size_id != 0 && $size_color->color_id != 0){
                ...
                join tbl_size s on s.Size_SlNo = pd.size_id
                join tbl_color c on c.color_SiNo = pd.color_id
                where pd.PurchaseMaster_IDNo = '$data->purchaseId'
            ")->result();
    ...
    public function addPurchase()
    {
        ...
        try{
            ...
            foreach($data->cartProducts as $product){
                ...
                $previousStock = $this->mt->productStock($product->productId, $product->size_id, $product->color_id);
