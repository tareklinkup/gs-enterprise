                    ...
                    <li style="float: left; padding: 0 10px;">
                        ...
                        <p style="padding:5px 0 0 0px; margin: 0px; font-weight: 500;">
                            ...
                            <i class="fa fa-arrow-down" aria-hidden="true"
                                style="padding-right: 1px; color:green; "></i>
                            <?php endif; ?>

                            <?= $transaction->Tr_Id.' - '.$tr_date.' - '.$transaction->Tr_Type.' - '?>
                            <?= ($transaction->Tr_Type== 'Out Cash' ||$transaction->Tr_Type == 'Deposit To Bank')? number_format($transaction->Out_Amount, 2): number_format($transaction->In_Amount, 2)?>
                        </p>
                    </li>
                    <?php endforeach;?>
                </ul>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 no-padding-right">
                                        <input class="form-control date-picker" id="paid_start_date" type="text"
                                            value="<?= date('Y-m-d')?>" placeholder="Start Date"
                                            data-date-format="yyyy-mm-dd"
                                            style="border-radius: 5px 0px 0px 5px !important; padding: 4px 6px 4px !important; width: 175px;float:left; " />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 no-padding-right">
                                        <input class="form-control date-picker" id="paid_end_date" type="text"
                                ...
                                <div class="col-sm-2">
                                    <input type="button" class="btn btn-info btn-xs"
                                        style="height: 25px; padding-top: 1px!important;" value="Search"
                                        onclick="top_paic_cus()">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="widget-main">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 no-padding-right">
                                        <input class="form-control date-picker" id="sale_start_date" name="sales_date"
                                            type="text" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text"
                                            data-date-format="yyyy-mm-dd"
                                            style="border-radius: 5px 0px 0px 5px !important; padding: 4px 6px 4px !important; width: 175px;float:left; " />
                                        <span class="input-group-addon"
                                            style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 no-padding-right">
                                        <input class="form-control date-picker" id="sale_end_date" name="sales_date"
                                            type="text" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text"
                                            data-date-format="yyyy-mm-dd"
                                            style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 175px;float:left;" />
                                        <span class="input-group-addon"
