			...
			<section class="" id="printButton" style="background:#f4f4f4;height:200px;">
			 <div class="">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" name="article" class="form-control mytext" required placeholder="Article ..." />
				</div>
				<div class="col-sm-2">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2"> 
				  <input type="text" name="qty" class="form-control mytext" required placeholder="Product quantity ...">
				</div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <section class="output">
					...
					?>
						...
						<div style="padding: 2px; float: left; height: 52px; width: 190px; border: 1px solid #ddd; margin:4px;">
							<div style="width: 190px; text-align: center; float: right;">
								<!--<span class="article" style="font-size: 12px;"><?php echo $article; ?></span>-->
								<p  style="margin:0;font-size: 10px; text-align: center;font-weight:bold;line-height: 1;"><?php echo $article; ?></p>
								<img src='<?php echo site_url();?>GenerateBarcode/<?php echo $PID;?>' style="height: 30px; width: 180px;" /><br>
								<p style="margin:0;text-align: center;font-size:9px;line-height: 1;"><?php echo $this->session->userdata('Currency_Name') . ' ' . $Price;?></p>
							</div>
						</div>
                    <?php 
						} 
