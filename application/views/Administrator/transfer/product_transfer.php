                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    ...
                                    <!-- 
                                    <div class="form-group">
                                        <label class="col-md-4 control-label no-padding-right"> Size </label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label no-padding-right"> Color </label>
                                        <div class="col-md-8">
                                            <v-select v-bind:options="colors" v-model="selectedColor"
                                                label="display_color" v-on:input="onChangeProduct"></v-select>
                                        </div>
                                    </div> -->
                                    <div class="form-group">
        ...
        async getTransfer() {
            ...
            this.cart = transferDetails.map(td => {
                let product = {
                    ...
                    size_id: td.size_id,
                    size_name: td.Size_Name,
                    color_id: td.color_id,
                    color_name: td.color_name,
