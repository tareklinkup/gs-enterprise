...
<div id="stock">
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
            ...
            <div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value == 'product_size'">
                <div class="col-sm-2" style="margin-left:15px;">
                    <v-select v-bind:options="colors" v-model="selectedColor" label="display_color"></v-select>
                </div>
            </div> -->
    ...
    methods: {
        ...
        getStock() {
            ...
            if (this.searchType == 'product_size' && this.selectedProduct == null) {
                ...
                return;
            } else if (this.searchType == 'product_size' && (this.selectedProduct != null)) {
                ...
                if (this.selectedColor != null && this.selectedColor.color_SiNo != null) {
                    parameters.color_id = this.selectedColor.color_SiNo;
                } else {
                    parameters.color_id = null;
                }
