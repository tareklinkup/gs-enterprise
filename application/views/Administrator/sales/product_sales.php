                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-4 control-label no-padding-right"> Product/Article
                                    </label>
                                    <div class="col-xs-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <v-select v-bind:options="sizes" v-model="selectedSize" label="Display_Size"
                                            v-on:input="productOnChange"></v-select>
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <a href="<?= base_url('size') ?>" title="Add New Size"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <v-select v-bind:options="colors" v-model="selectedColor" label="display_color"
                                            v-on:input="productOnChange"></v-select>
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <a href="<?= base_url('color') ?>" title="Add New Color"
                                            class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank"><i class="fa fa-plus" aria-hidden="true"
                                                style="margin-top: 5px;"></i></a>
...
new Vue({
    ...
    methods: {
        ...
        addToCart() {
            ...
            let product = {
                productId: this.selectedProduct.Product_SlNo,
                size_id: this.selectedSize.Size_SlNo ? this.selectedSize.Size_SlNo : '',
                size_name: this.selectedSize.Size_Name,
                color_id: this.selectedColor.color_SiNo ? this.selectedColor.color_SiNo : '',
            ...
            let cartInd = this.cart.findIndex(p => p.productId == product.productId && p.size_id == product
                .size_id && p.color_id == product.color_id);
            if (cartInd > -1) {
