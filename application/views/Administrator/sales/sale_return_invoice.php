            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Return Date:</strong> {{ saleReturn.SaleReturn_ReturnDate }}
                        {{ moment(saleReturn.AddTime).format('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ convertNumberToWords(saleReturn.SaleReturn_ReturnAmount) }}<br><br>
                        <strong>Note: </strong>
