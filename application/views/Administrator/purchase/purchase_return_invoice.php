            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Return Date:</strong> {{ purchaseReturn.PurchaseReturn_ReturnDate }}
                        {{ moment(purchaseReturn.AddTime).format('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ convertNumberToWords(purchaseReturn.PurchaseReturn_ReturnAmount) }}<br><br>
                        <strong>Note: </strong>
